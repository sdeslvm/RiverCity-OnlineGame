...
# Параметры
BUNDLE_ID="com.riv.erocit"
APPLE_ID="6746712638"
REMOTE_URL="git@github.com:sdeslvm/RiverCity-OnlineGame.git"
PROJECT_NAME="River City Online Game"
SCHEME_NAME="River City Online Game"
